...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference("Facultie.count") do
      post faculties_url, params: { faculty: { name: @faculty.name } }
    end

    assert_redirected_to faculty_url(Facultie.last)
  end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { name: @faculty.name } }
    assert_redirected_to faculty_url(@faculty)
  end

  test "should destroy faculty" do
    assert_difference("Facultie.count", -1) do
